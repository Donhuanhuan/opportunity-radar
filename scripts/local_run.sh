...
checks.append(('草稿表 APP_TOKEN', bool(os.environ.get('DRAFTS_BITABLE_APP_TOKEN'))))
checks.append(('草稿表 TABLE_ID', bool(os.environ.get('DRAFTS_BITABLE_TABLE_ID'))))
checks.append(('审核表 APP_TOKEN', bool(os.environ.get('FEISHU_AUDIT_APP_TOKEN'))))
